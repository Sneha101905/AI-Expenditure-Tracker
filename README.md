...
A Python command-line tool to log, view, and analyze personal spending, extended with an AI-powered natural language interface via the Anthropic API.
...
- Chat with your expenses in plain English using Claude (Anthropic API)
...
Sign up at [console.anthropic.com](https://console.anthropic.com) and create an API key. You can either paste it when prompted by the program, or set it as an environment variable:
...
Expenses are stored locally in an `expenses.csv` file. When you open the AI chat (option 4), your complete expense history is formatted and sent to Claude as context alongside your question. The model reasons over your real data to generate answers. 
